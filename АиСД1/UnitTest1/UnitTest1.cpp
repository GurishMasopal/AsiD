...
namespace UnitTestlab1
{
	...
	public:
		...
		TEST_METHOD(reverseTest) 
		       {
				List list_one;
				list_one.push_front(4);
				list_one.push_front(3);
				list_one.push_front(2);
				list_one.push_front(1);
				list_one.push_front(0);
				Assert::IsTrue(list_one.at(0) == 0);
				Assert::IsTrue(list_one.at(1) == 1);
				Assert::IsTrue(list_one.at(2) == 2);
				Assert::IsTrue(list_one.at(3) == 3);
				Assert::IsTrue(list_one.at(4) == 4);
				list_one.reverse();
				Assert::IsTrue(list_one.at(0) == 4);
				Assert::IsTrue(list_one.at(1) == 3);
				Assert::IsTrue(list_one.at(2) == 2);
				Assert::IsTrue(list_one.at(3) == 1);
				Assert::IsTrue(list_one.at(4) == 0);
			   }
	};
}